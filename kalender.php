...
$nbc="ffffff"; // NORMAL BACKGROUND COLOR
$abc="E9B4A1"; // MARKED BACKGROUND COLOR
$tbc="pink"; // TODAY'S BACKGROUND COLOR
...
if (!$nt) $nt=0;
if (!$ctime) $ctime = "-0";
if (!$tw) $tw="180"; // Table Width
if (!$ch) $ch="";   // Cell Height
if (!$algn) $algn="0";
if (!$fsm) $fsm="12"; // FONT SIZE MONTH
...
<style TYPE="text/css">
<!--
.monthyear {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: <?echo$fsm?>px; font-weight: <?echo$fwm?>; color:#C00;}
...
if ($algn==0) $algn="align='left' valign='middle'";
...
<table WIDTH="<? echo$tw?>" BORDER="0" CELLSPACING="1" CELLPADDING="1" CLASS="daynames">
  <tr ALIGN="center"> 
<?php
for ($I=0;$I<7;$I++) {
$dayprint=$daystart+$I;
